""" Items levels and Gearscore relations functions """
...
def createGearScoreDictionnary():
    """ Create a dictionnary to link item levels and their corresponding gear score """
    dictionnary = {}
        ...
        for itemLevel in itemLevels:
            ...
            for itemRarity in itemRarities:
                ...
                for legendaryGsItemsName in legendaryGsItemsNames:
                    ...
                    if itemRarity == '5':
                        if (
                                itemSlot == 'Main Hand' and
                                itemLevel == '245' and
                                legendaryGsItemsName == legendaryGsItemsNames[0]
                        ):
                            dictionnary[itemSlot][itemLevel][itemRarity] = legendaryGsItemsValues[0]
                            break
                        if (
                                itemSlot == 'Two-hand' and
                                itemLevel == '284' and
                                legendaryGsItemsName == legendaryGsItemsNames[1]
                        ):
                ...
                # each time we loop over itemLevel
...
def getItemGearScore(
        gearScoreDict, selectedItemSlot, selectedItemLevel, selectedItemQuality
):
    """ Get item Gear Score """
    ...
    try:
        itemGearScore = gearScoreDict[selectedItemSlot][selectedItemLevel][selectedItemQuality]
